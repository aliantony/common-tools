...
public enum AssetSoftwareStatusJumpEnum {
    ...
    AssetSoftwareStatusJumpEnum(Integer currentStatus, Integer agreeStatus, Integer refuseStatus) {
    ...
    public static Integer getNextStatus(Integer currentStatus, Integer isAgree) {
        for (AssetSoftwareStatusJumpEnum statusJumpEnum : AssetSoftwareStatusJumpEnum.values()) {
