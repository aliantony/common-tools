...
public enum AssetEventEnum {
    ...
    ASSET_EXPORT_OTHERS(10, "导入资产信息"),
    ASSET_EXPORT_SAFETY(11, "导入资产信息"),
    ASSET_EXPORT_STORAGE(12, "导入资产信息"),
    ...
    ASSET_GROUP_DELETE(20, "注销资产组信息"),
    ASSET_GROUP_INSERT(21, "登记资产组信息"),
    ASSET_GROUP_UPDATE(22, "变更资产组信息"),
    ...
    ASSET_REPORT_EXPORT(82, "资产报表导出"),
    ASSET_REPORT_IMPORT(83, "资产报表导入"),
    ASSET_SAFETY_EQUIPMENT_INSERT(84, "硬件资产安全设备新增"),
    ASSET_SAFETY_EQUIPMENT_UPDATE(85, "硬件资产安全设备修改"),
    ASSET_SAFETY_EQUIPMENT_DELETE(86, "硬件资产安全设备删除"),
    SOFTWARE_LICENSE_INSERT(87, "软件许可新增"),
    SOFTWARE_LICENSE_DELETE(88, "软件许可删除"),
    SOFTWARE_LICENSE_UPDATE(89, "软件许可修改"),
    SOFT_INSTALL_MANUAL(90, "软件资产人工安装"),
    SOFT_INSTALL_AUTO(91, "软件资产自动安装"),
    FILE_UPLOAD(92, "文件上传"),
    FILE_DOWNLOAD(93, "文件下载"),
    HARDWARE_CONFIG(94, "硬件资产配置"),
    ASSET_ADMITTANCE_EXPORT(101, "资产准入管理导出"),
    SOFT_CONFIG(100, "软件配置"),
    RETIRE_REGISTER(101, "登记资产"),
    GET_USER_INOF(102, "获取登录用户"),
    ASSET_STATUS_SCHEDULE_TASK(103, "执行资产状态定时任务"),
    NO_REGISTER(104, "不予登记资产"),
    SETTING_REGISTER(105, "登记资产"),
    SOFT_NO_REGISTER(106, "软件不予登记"),
    HARD_EXPORT(109, "硬件资产导出"),
    HARD_WAITTING_REGISTER(110, "登记资产"),
    ASSET_RETIRE_START(111, "资产发起退役"),
    ASSET_RETIRE_IMPL(112, "资产实施退役"),
    HARD_NO_REGISTER(113, "登记资产"),
    TEMPLATE_CREATION(114, "创建装机模板"),
    TEMPLATE_DELETE(115, "删除装机模板"),
    ...
    ADD_ASSET_MONITOR_RULE(121, "新增资产监控规则"),
    UPDATE_ASSET_MONITOR_RULE(122, "修改资产监控规则"),
    DELETE_ASSET_MONITOR_RULE(123, "删除资产监控规则"),
