...
public class AssetUserRequest extends BasicRequest implements ObjectValidator {
    ...
    @Size(message = "电子邮箱应在0~30字符", max = 30)
    private String email;
    /**
     * qq号
     */
    @ApiModelProperty("qq号")
    @Size(message = "qq号应在0~30字符", max = 30)
    private String qq;
    /**
     * 微信
     */
    @ApiModelProperty("微信")
    @Size(message = "微信应在0~30字符", max = 30)
     ...
     */
    @ApiModelProperty("住址")
    @Size(message = "住址应在0~50字符", max = 50)
    private String address;
    /**
     * 详细地址
     */
    @ApiModelProperty("详细地址")
    @Size(message = "详细地址应在0~50字符", max = 50)
    private String detailAddress;
    /**
     * 职位
     */
    @ApiModelProperty("职位")
    @Size(message = "职位应在0~30字符", max = 30)
    ...
    public void validate() throws RequestParamValidateException {
        ...
        if (mobile != null && !"".equals(mobile)) {
            ParamterExceptionUtils.isTrue(mobile.length() == 11, "手机号码只能为11位");
        }
    }
