...
public class Event extends BaseEntity {
    ...
    public String toString() {
        return "Event [name=" + name + ", reward=" + reward + ", processMethod=" + processMethod + ", idStars="
               + idStars + ", integral=" + integral + ", editName=" + editName + ", editReward=" + editReward
               + ", editProcessMethod=" + editProcessMethod + ", editIdStars=" + editIdStars + ", editIntegral="
               + editIntegral + ", auditStatus=" + auditStatus + ", auditTime=" + auditTime + ", creatorId=" + creatorId
               + ", creatorName=" + creatorName + ", createTime=" + createTime + ", updateUserId=" + updateUserId
               + ", updateUserName=" + updateUserName + ", updateTime=" + updateTime + ", isDelete=" + isDelete
               + ", isActive=" + isActive + "]";
    }
