...
public class AssetSoftware extends BaseEntity {
    ...
    public String toString() {
        return "AssetSoftware{" + ", size=" + size + ", operationSystem=" + operationSystem + ", category=" + category
               + ", model=" + model + ", name=" + name + ", uploadSoftwareName=" + uploadSoftwareName + ", path=" + path
               + ", version=" + version + ", manufacturer=" + manufacturer + ", description=" + description
               ...
               + ", releaseTime=" + releaseTime + ", publisher=" + publisher + ", gmtCreate=" + gmtCreate + ", memo="
               + memo + ", gmtModified=" + gmtModified + ", createUser=" + createUser + ", modifyUser=" + modifyUser
               + ", status=" + status + "}";
    }
}