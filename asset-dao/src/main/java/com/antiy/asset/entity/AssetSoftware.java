...
public class AssetSoftware extends BaseEntity {
    ...
    public String toString() {
        return "AssetSoftware{" + ", size=" + size + ", operationSystem=" + operationSystem + ", categoryModel="
               + categoryModel + ", name=" + name + ", uploadSoftwareName=" + uploadSoftwareName + ", path=" + path
               ...
               + port + ", language=" + language + ", releaseTime=" + releaseTime + ", publisher=" + publisher
               + ", gmtCreate=" + gmtCreate + ", memo=" + memo + ", gmtModified=" + gmtModified + ", createUser="
