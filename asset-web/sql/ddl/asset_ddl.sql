...
CREATE TABLE `asset` (
  ...
  `operation_system` bigint(20) COMMENT '操作系统',
  `operation_system_name` varchar(128) DEFAULT NULL COMMENT '操作系统名称',
  ...
  `version` varchar(1024) NULL COMMENT '版本',
...
CREATE TABLE `asset_install_template_check` (
  ...
  `advice` varchar(300) DEFAULT NULL COMMENT '审核意见',
...
CREATE TABLE `asset_network_equipment` (
  ...
  `cpu_size` float DEFAULT NULL COMMENT 'CPU大小',
...
CREATE TABLE `asset_operation_record` (
  ...
  `note` varchar(1024) NULL DEFAULT '' COMMENT '当前操作输入的备注信息',
  `file_info` varchar(1024) NULL DEFAULT '' COMMENT '附件信息JSON',
  `gmt_create` bigint(20) NOT NULL DEFAULT '0' COMMENT '创建时间',
  `create_user` int(11) NOT NULL DEFAULT '0' COMMENT '创建人',
...
--
-- Table structure for table `asset_cpe_update_record`
--
...
--
-- Dumping data for table `asset_cpe_update_record`
--

LOCK TABLES `asset_cpe_update_record` WRITE;
/*!40000 ALTER TABLE `asset_cpe_update_record` DISABLE KEYS */;
/*!40000 ALTER TABLE `asset_cpe_update_record` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
