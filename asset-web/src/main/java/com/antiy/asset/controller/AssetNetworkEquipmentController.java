...
public class AssetNetworkEquipmentController {
    ...
    @PreAuthorize(value = "hasAuthority('asset:assetnetworkequipment:saveSingle')")
    ...
    @PreAuthorize(value = "hasAuthority('asset:assetnetworkequipment:updateSingle')")
    ...
    @PreAuthorize(value = "hasAuthority('asset:assetnetworkequipment:queryList')")
    ...
    @PreAuthorize(value = "hasAuthority('asset:assetnetworkequipment:queryById')")
    ...
    @PreAuthorize(value = "hasAuthority('asset:assetnetworkequipment:deleteById')")
