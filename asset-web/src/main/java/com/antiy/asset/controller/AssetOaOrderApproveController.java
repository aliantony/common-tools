...
public class AssetOaOrderApproveController {
    ...
    public ActionResponse queryById(@ApiParam(value = "assetOaOrderApprove") @RequestBody QueryCondition queryCondition)throws Exception{
        ParamterExceptionUtils.isNull(queryCondition.getPrimaryKey(), "ID不能为空");
        return ActionResponse.success(iAssetOaOrderApproveService.getById(Integer.parseInt(queryCondition.getPrimaryKey())));
    }
    ...
    public ActionResponse deleteById(@ApiParam(value = "id") @RequestBody QueryCondition queryCondition)throws Exception{
        ParamterExceptionUtils.isNull(queryCondition.getPrimaryKey(), "ID不能为空");
        return ActionResponse.success(iAssetOaOrderApproveService.deleteById(Integer.parseInt(queryCondition.getPrimaryKey())));
    }
}
