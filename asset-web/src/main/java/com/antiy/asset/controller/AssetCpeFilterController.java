...
@RestController
@RequestMapping("/api/v1/asset/assetcpefilter")
public class AssetCpeFilterController {
    ...
    public ActionResponse saveSingle(@ApiParam(value = "assetCpeFilter") @RequestBody AssetCpeFilterRequest assetCpeFilterRequest) throws Exception {
    ...
    public ActionResponse updateSingle(@ApiParam(value = "assetCpeFilter") AssetCpeFilterRequest assetCpeFilterRequest) throws Exception {
    ...
    @ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = AssetCpeFilterResponse.class, responseContainer = "List"), })
    @RequestMapping(value = "/query/list", method = RequestMethod.GET)
    public ActionResponse queryList(@ApiParam(value = "assetCpeFilter") AssetCpeFilterQuery assetCpeFilterQuery) throws Exception {
