...
public class AssetLableController {
    ...
    @PreAuthorize("hasAuthority('asset:label:saveSingle')")
    ...
    @PreAuthorize("hasAuthority('asset:label:updateSingle')")
    ...
    @PreAuthorize("hasAuthority('asset:label:queryList')")
    ...
    @PreAuthorize("hasAuthority('asset:label:queryById')")
    ...
    @PreAuthorize("hasAuthority('asset:label:deleteById')")
