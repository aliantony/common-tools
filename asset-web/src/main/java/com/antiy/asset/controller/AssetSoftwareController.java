...
public class AssetSoftwareController {
    ...
    @PreAuthorize(value = "hasAuthority('asset:assetsoftware:saveSingle')")
    ...
    @PreAuthorize(value = "hasAuthority('asset:assetsoftware:updateSingle')")
    ...
    @PreAuthorize(value = "hasAuthority('asset:assetsoftware:queryList')")
    ...
    @PreAuthorize(value = "hasAuthority('asset:assetsoftware:queryById')")
    ...
    @PreAuthorize(value = "hasAuthority('asset:assetsoftware:deleteById')")
