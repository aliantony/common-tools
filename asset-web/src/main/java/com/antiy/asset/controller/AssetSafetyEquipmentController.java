...
public class AssetSafetyEquipmentController {
    ...
    @PreAuthorize(value = "hasAuthority('asset:assetsafetyequipment:saveSingle')")
    ...
    @PreAuthorize(value = "hasAuthority('asset:assetsafetyequipment:updateSingle')")
    ...
    @PreAuthorize(value = "hasAuthority('asset:assetsafetyequipment:queryList')")
    ...
    @PreAuthorize(value = "hasAuthority('asset:assetsafetyequipment:queryById')")
    ...
    @PreAuthorize(value = "hasAuthority('asset:assetsafetyequipment:deleteById')")
