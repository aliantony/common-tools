...
public class AssetGroupController {
    ...
    @PreAuthorize(value = "hasAuthority('asset:group:queryGroupInfo')")
    public ActionResponse<List<SelectResponse>> queryUnconnectedGroupInfo(@ApiParam("二级品类名") String secondCategoryName) throws Exception {
        return ActionResponse.success(iAssetGroupService.queryUnconnectedGroupInfo(secondCategoryName));
    }
