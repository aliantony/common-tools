...
public class SafetyEquipmentEntiy {
     ...
     * 操作系统
     */
    @ExcelField(value = "operationSystem", align = 1, title = "操作系统", required = true, defaultDataMethod = "getAllSystemOs", defaultDataBeanName = "assetTemplateServiceImpl", length = 128)
