...
public class SafetyEquipmentEntiy {
     ...
     * 操作系统
     */
    @ExcelField(value = "operationSystem", align = 1, title = "操作系统", required = false, defaultDataMethod = "getAllSystemOs", defaultDataBeanName = "assetTemplateServiceImpl", length = 128)
     ...
     * p地址
     */
    @ExcelField(value = "ip", align = 1, title = "ip地址(必填)", dataType = DataTypeEnum.IP, required = true)
    private String ip;
    /**
     * ip地址
     */
