...
public class AssetSoftwareEntity {
    ...
    public String toString() {
        return "AssetSoftwareEntity{" + "name='" + name + '\'' + ", size=" + size + ", operationSystem='"
               + operationSystem + '\'' + ", category=" + category + ", model=" + model + ", uploadSoftwareName='"
               + uploadSoftwareName + '\'' + ", path='" + path + '\'' + ", version='" + version + '\''
               + ", manufacturer='" + manufacturer + '\'' + ", description='" + description + '\'' + ", softwareLabel="
               + softwareLabel + ", softwareStatus=" + softwareStatus + ", authorization=" + authorization
               + ", reportSource=" + reportSource + ", port='" + port + '\'' + ", language='" + language + '\''
               + ", releaseTime=" + releaseTime + ", publisher='" + publisher + '\'' + '}';
    }

    public AssetSoftwareEntity(String name, Integer size, String operationSystem, Integer category, Integer model,
                               String uploadSoftwareName, String path, String version, String manufacturer,
                               String description, Integer softwareLabel, Integer softwareStatus, Integer authorization,
                               Integer reportSource, String port, String language, Long releaseTime, String publisher) {
        this.name = name;
        this.size = size;
        this.operationSystem = operationSystem;
        this.category = category;
