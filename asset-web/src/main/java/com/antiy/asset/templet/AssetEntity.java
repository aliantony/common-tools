...
public class AssetEntity {
    ...
    public String toString() {
        return "AssetEntity{" + "type=" + type + ", name='" + name + '\'' + ", serial='" + serial + '\'' + ", category="
               + category + ", model=" + model + ", manufacturer='" + manufacturer + '\'' + ", assetStatus="
               + assetStatus + ", operationSystem='" + operationSystem + '\'' + ", systemBit=" + systemBit
               + ", location='" + location + '\'' + ", firmwareVersion='" + firmwareVersion + '\''
               + ", responsibleUserId=" + responsibleUserId + ", hardDisk='" + hardDisk + '\'' + ", memory='" + memory
               + '\'' + ", assetSource=" + assetSource + ", importanceDegree=" + importanceDegree + ", cpu='" + cpu
               + '\'' + ", networkCard='" + networkCard + '\'' + ", describle='" + describle + '\'' + ", tags='" + tags
               + '\'' + ", isInnet=" + isInnet + ", serviceLife=" + serviceLife + ", buyDate=" + buyDate + ", warranty="
               + warranty + '}';
    }

    public AssetEntity(Integer type, String name, String serial, Integer category, Integer model, String manufacturer,
                       Integer assetStatus, String operationSystem, Integer systemBit, String location,
                       String firmwareVersion, Integer responsibleUserId, String hardDisk, String memory,
                       Integer assetSource, Integer importanceDegree, String cpu, String networkCard, String describle,
                       String tags, Integer isInnet, Long serviceLife, Long buyDate, Long warranty) {
        this.type = type;
        this.name = name;
        this.serial = serial;
        this.category = category;
