...
public interface IAssetService extends IBaseService<Asset> {
     ...
     */
    void exportData(AssetMultipleQuery assetQuery, HttpServletResponse servletResponse,
     ...
     * @return
     */
    PageResult<AssetResponse> queryAssetPage(AssetMultipleQuery asset) throws Exception;
