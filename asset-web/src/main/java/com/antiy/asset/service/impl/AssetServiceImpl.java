...
public class AssetServiceImpl extends BaseServiceImpl<Asset> implements IAssetService {
        ...
        Integer num = transactionTemplate.execute(new TransactionCallback<Integer>() {
            ...
            public Integer doInTransaction(TransactionStatus transactionStatus) {
                try {
                    ...
                    LogHandle.log(asset, AssetEventEnum.ASSET_INSERT.getName(), AssetEventEnum.ASSET_INSERT.getStatus(),
     ...
     * @param id 查询的品类id
     */
    private List<AssetCategoryModel> recursionSearch(List<AssetCategoryModel> list, Integer id) throws Exception {
