...
public class SafetyEquipmentFieldCompareImpl extends AbstractChangeRecordCompareImpl {
    ...
    private List<Map<String, Object>> getDetailCompareResult(AssetOuterRequest oldAssetOuterRequest,
        ...
        AssetSafetyEquipment oldSafetyEquipment = new AssetSafetyEquipment();
        oldSafetyEquipment.setIp(oldSafetyEquipmentRequest.getIp());
        oldSafetyEquipment.setMac(oldSafetyEquipmentRequest.getMac());

        AssetSafetyEquipment newSafetyEquipment = new AssetSafetyEquipment();
        newSafetyEquipment.setIp(newSafetyEquipmentRequest.getIp());
        newSafetyEquipment.setMac(newSafetyEquipmentRequest.getMac());

        return CompareUtils.compareClass(oldSafetyEquipment, newSafetyEquipment, InfoLabelEnum.BUSINESSINFO.getMsg());
    }
