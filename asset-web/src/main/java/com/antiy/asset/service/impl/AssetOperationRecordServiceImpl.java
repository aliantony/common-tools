...
public class AssetOperationRecordServiceImpl extends BaseServiceImpl<AssetOperationRecord>
    ...
    @Override
    public List<AssetOperationRecordBarResponse> findAssetOperationRecordBarByAssetId(AssetOperationRecordQuery assetOperationRecordQuery) {
        List<AssetOperationRecordBarPO> barResponseList = assetOperationRecordDao
            .findAssetOperationRecordBarByAssetId(assetOperationRecordQuery);
        if (barResponseList == null || barResponseList.isEmpty()) {
            return Lists.newArrayList();
        }

        return responseConverter.convert(barResponseList, AssetOperationRecordBarResponse.class);
    }
...
//        for (AssetOperationRecordBarPO assetOperationRecordBarPO : list){

            map.put("originStatus", AssetStatusEnum.WATI_REGSIST.getCode());
            statusBarMap.put(AssetStatusEnum.WATI_REGSIST.getCode(),getAssetOperationRecordBarResponses(map,assetOperationRecordQuery));

            map.put("originStatus", AssetStatusEnum.NOT_REGSIST.getCode());
            statusBarMap.put(AssetStatusEnum.NOT_REGSIST.getCode(),getAssetOperationRecordBarResponses(map,assetOperationRecordQuery));

            map.put("originStatus", AssetStatusEnum.WAIT_SETTING.getCode());
            statusBarMap.put(AssetStatusEnum.WAIT_SETTING.getCode(),getAssetOperationRecordBarResponses(map,assetOperationRecordQuery));

            map.put("originStatus", AssetStatusEnum.WAIT_VALIDATE.getCode());
            statusBarMap.put(AssetStatusEnum.WAIT_VALIDATE.getCode(),getAssetOperationRecordBarResponses(map,assetOperationRecordQuery));

            map.put("originStatus", AssetStatusEnum.WAIT_NET.getCode());
            statusBarMap.put(AssetStatusEnum.WAIT_NET.getCode(),getAssetOperationRecordBarResponses(map,assetOperationRecordQuery));

            map.put("originStatus", AssetStatusEnum.WAIT_CHECK.getCode());
            statusBarMap.put(AssetStatusEnum.WAIT_CHECK.getCode(),getAssetOperationRecordBarResponses(map,assetOperationRecordQuery));

            map.put("originStatus", AssetStatusEnum.NET_IN.getCode());
            statusBarMap.put(AssetStatusEnum.NET_IN.getCode(),getAssetOperationRecordBarResponses(map,assetOperationRecordQuery));

            map.put("originStatus", AssetStatusEnum.WAIT_RETIRE.getCode());
            statusBarMap.put(AssetStatusEnum.WAIT_RETIRE.getCode(),getAssetOperationRecordBarResponses(map,assetOperationRecordQuery));

            map.put("originStatus", AssetStatusEnum.RETIRE.getCode());
            statusBarMap.put(AssetStatusEnum.RETIRE.getCode(),getAssetOperationRecordBarResponses(map,assetOperationRecordQuery));
//        }
    ...
    private List<AssetOperationRecordBarResponse> getAssetOperationRecordBarResponses(HashMap<String, Object> map,AssetOperationRecordQuery assetOperationRecordQuery) {
