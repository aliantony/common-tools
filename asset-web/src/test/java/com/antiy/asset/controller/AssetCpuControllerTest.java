...
public class AssetCpuControllerTest {
    ...
    public void saveSingle() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/asset/cpu/save/single")
    ...
    public void updateSingle() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/asset/cpu/update/single")
            .contentType(MediaType.APPLICATION_JSON).content(JSONObject.toJSONString(assetCpu))).andReturn();
    ...
    public void queryList() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/asset/cpu/query/list")
            .contentType(MediaType.APPLICATION_JSON).content(JSONObject.toJSONString(assetCpu))).andReturn();
    ...
    public void queryById() throws Exception {
        ...
        MvcResult mvcResult = mockMvc
            .perform(MockMvcRequestBuilders.get("/api/v1/asset/cpu/query").param("primaryKey", "1")).andReturn();
    ...
    public void deleteById() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/asset/cpu/delete")
