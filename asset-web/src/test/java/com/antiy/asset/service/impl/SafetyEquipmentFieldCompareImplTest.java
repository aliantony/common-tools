...
public class SafetyEquipmentFieldCompareImplTest {

    /**
     * 被测试service
     */
    @InjectMocks
    private SafetyEquipmentFieldCompareImpl compare;
    ...
    public void compareCommonBusinessInfo() throws Exception {
        ...
        strings.add("{\"asset\": {\"areaId\":\"2333\", \"responsibleUserId\":\"110\", \"name\":\"Leo\", \"manufacturer\":\"110\", \"serial\":\"110\"}, \"safetyEquipment\":{\"mac\":\"123\"}}");
        strings.add("{\"asset\": {\"areaId\":\"2333\", \"responsibleUserId\":\"110\", \"name\":\"Leo\", \"manufacturer\":\"171\", \"serial\":\"233\"}, \"safetyEquipment\":{\"mac\":\"321\"}}");
