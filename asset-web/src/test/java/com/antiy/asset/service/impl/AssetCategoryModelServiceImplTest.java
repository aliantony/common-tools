...
public class AssetCategoryModelServiceImplTest {
    ...
    public void queryCategoryNodeTest() throws Exception {
        ...
        Assert.assertNull(assetCategoryModelServiceImpl.queryCategoryNode());
    }
    ...
    public void queryCategoryNodeByTypeTest() throws Exception {
        ...
        Integer type = 1;
        Mockito.when(assetCategoryModelDao.findListAssetCategoryModel(Mockito.any())).thenReturn(list);
        Assert.assertNull(assetCategoryModelServiceImpl.queryCategoryNode(type));
    }
    ...
    public void querySecondCategoryNodeTest() throws Exception {
        ...
        AssetCategoryModelNodeResponse nodeResponse = new AssetCategoryModelNodeResponse();
        AssetCategoryModelNodeResponse expect = new AssetCategoryModelNodeResponse();
        AssetCategoryModelNodeResponse childNodeResponse = new AssetCategoryModelNodeResponse();
        childNodeResponse.setName(Constants.FIRST_LEVEL_ASSET_CATEGORY_NAME);
        List<AssetCategoryModelNodeResponse> list1 = new ArrayList<>();
        list1.add(childNodeResponse);
        nodeResponse.setChildrenNode(list1);
        Map<String, String> initMap = new HashMap<>(1);
        Mockito.when(assetCategoryModelDao.findListAssetCategoryModel(Mockito.any())).thenReturn(list);
        PowerMockito.doReturn(nodeResponse).when(assetCategoryModelServiceImpl, "getAssetCategoryModelNodeResponse", Mockito.anyList());
        PowerMockito.doReturn(expect).when(assetCategoryModelServiceImpl, "getSecondCategoryModelNodeResponse", Mockito.any(), Mockito.anyString(), Mockito.anyMap());
        PowerMockito.doReturn(initMap).when(assetCategoryModelServiceImpl).getSecondCategoryMap();
        Assert.assertEquals(expect, assetCategoryModelServiceImpl.querySecondCategoryNode(types).getChildrenNode().get(0));
    }
...
//       Mockito.verify(responseConverter).convert(getAssetCategoryModel(),);
    ...
    protected AssetCategoryModel getAssetCategoryModel() {
        ...
        assetCategoryModel.setParentId("101");
        assetCategoryModel.setAssetType(2);
