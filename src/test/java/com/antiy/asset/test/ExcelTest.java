...
import com.antiy.asset.entity.vo.templet.AssetUserEntity;
import com.antiy.asset.excel.ExcelUtils;
import com.antiy.asset.excel.User;
    ...
    public void importFileToDataBase3() {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            try {
                ...
                assetSoftwareService.save(assetSoftware);
            } catch (Exception e) {
                e.printStackTrace();
            }
//            assetService.insert((Asset) dataList.get(i));
    ...
    public void importFileToDataBase4() {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            try {
                ...
                assetDepartmentService.save(assetDepartment);
//                assetSoftwareService.insert(assetSoftware);
            } catch (Exception e) {
                e.printStackTrace();
            }
